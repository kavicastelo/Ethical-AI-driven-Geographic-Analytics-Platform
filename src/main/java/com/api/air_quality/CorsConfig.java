...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/api/v1") // Specify the mapping pattern you want to allow CORS for
                .allowedOrigins("http://localhost:3269") // Allow requests from this origin uncomment this line to run on localhost
//                .allowedOrigins("https://seeker-by-kavi.netlify.app") // Allow requests from this origin
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://localhost:3269"); // uncomment this line to run on localhost
