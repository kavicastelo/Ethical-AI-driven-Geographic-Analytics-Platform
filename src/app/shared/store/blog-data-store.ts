...
export var blogDataStore: BlogModel[] = [
  ...
  },
  {
    ...
    content: [{mainTitle: "main title 2"}, {mainContent: "main content 2"}, {subTitle: ["sub title 1", "sub title 2", "sub title 3"]}, {subContent: ["sub content 1", "sub content 2", "sub content 3"]}],
  ...
  },
  {
    ...
    content: [{mainTitle: "main title 3"}, {mainContent: "main content 3"}, {subTitle: ["sub title 1", "sub title 2", "sub title 3"]}, {subContent: ["sub content 1", "sub content 2", "sub content 3"]}],
  ...
  },
  {
    ...
    content: [{mainTitle: "main title 4"}, {mainContent: "main content 4"}, {subTitle: ["sub title 1", "sub title 2", "sub title 3"]}, {subContent: ["sub content 1", "sub content 2", "sub content 3"]}],
  ...
  },
  {
    ...
    content: [{mainTitle: "main title 5"}, {mainContent: "main content 5"}, {subTitle: ["sub title 1", "sub title 2", "sub title 3"]}, {subContent: ["sub content 1", "sub content 2", "sub content 3"]}],
